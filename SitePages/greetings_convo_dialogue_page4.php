...
<div class="row ykmainbodywrapper">
	    ...
	    <div class="small-6 columns ykmainbody">
            ...
            <div class="row yk_dialogue_images">
                    ...
                    <div class="small-6 columns">
                                ...
                                <div class="row">
                                        ...
                                        <div class="small-4 columns">
                                             <img class="hint_pic hint_pic_1" src="../Images/Images8InEach/Vocab/greetings/Ireland.jpg" />   
                                        </div>
                                            
                                        <div class="small-8 columns">
                                              <img class="pic_left_1" src="../Images/Dialogue/Seamus200.png" />  
                                        </div>
                    ...
                    <div class="medium-6 columns">
                                ...
                                <div class="row">
                                        ...
                                        <div class="small-8 columns">
                                              <img class="pic_right_1" src="../Images/Dialogue/Emma200.png" />   
                                        </div>
                                        
                                        <div class="small-4 columns">
                                               <img class="hint_pic hint_pic_2" src="../Images/Images8InEach/Vocab/greetings/Britain.jpg" /> 
                                        </div>
            ...
            <div class="row yk_left_and_right_person_dialogue_row">                        		
                   ...
                   <div class="small-6 columns yk_left_person_dialogue">
                      ...
                      <div class="dial"><p class="dial_left_2">I’m from <u>Ireland</u>.<br />
                        I’m <u>Irish</u>.<br />
                         Nice to meet you.</p></div>
                    </div>
                    
                    <div class="small-6 columns yk_right_person_dialogue">                    
                      <div class="dial"><p class="dial_right_1">I’m from <u>the UK</u>.<br />
                        I’m <u>British</u>.<br />
                         How about you?</p></div>
            ...
            <a class="button" href="greetings_convo_dialogue_page3.php">Previous</a>
            <a class="button" id="reset">Again </a>
            <a class="button" href="greetings_convo_dialogue.php">Back to start</a>
        ...
        <div>
            		<audio id="yk_audio_dialogue_1">
                           <source src="../Audio/greetings/Dialogue/seamus1.mp3" type="audio/mpeg">
                            Your browser does not support the audio element.
                    </audio>
                    
                    <audio id="yk_audio_dialogue_2">
                           <source src="../Audio/greetings/Dialogue/emma1.mp3" type="audio/mpeg">
                            Your browser does not support the audio element.
                    </audio>
                    
                    <audio id="yk_audio_dialogue_3">
                           <source src="../Audio/greetings/Dialogue/seamus2.mp3" type="audio/mpeg">
                            Your browser does not support the audio element.
                    </audio>
                    
                     <audio id="yk_audio_dialogue_4">
                           <source src="../Audio/greetings/Dialogue/emma2.mp3" type="audio/mpeg">
                            Your browser does not support the audio element.
                    </audio>
        </div>
