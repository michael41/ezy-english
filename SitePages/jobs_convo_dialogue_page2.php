...
<div class="row ykmainbodywrapper">
	    ...
	    <div class="small-6 columns ykmainbody">
            ...
            <div class="row yk_dialogue_images">
                    ...
                    <div class="small-6 columns">
                                ...
                                <div class="row">
                                        ...
                                        <div class="small-4 columns">
                                             <img class="hint_pic hint_pic_1" src="../Images/Dialogue/tip_lawfirm.png" />   
                                        </div>
                                            
                                        <div class="small-8 columns">
                                              <img class="pic_left_1" src="../Images/Dialogue/Lawyer.png" />  
                                        </div>
                    ...
                    <div class="medium-6 columns">
                                ...
                                <div class="row">
                                        ...
                                        <div class="small-8 columns">
                                              <img class="pic_right_1" src="../Images/Dialogue/Doctor.png" />   
                                        </div>
            ...
            <div class="row yk_left_and_right_person_dialogue_row">                        		
                    ...
                    <div class="small-6 columns yk_left_person_dialogue">
                      ...
                      <div class="dial"><p class="dial_left_2">I'm a <u>lawyer</u>. <br />
                                                               I work <u>for McBeal Law Firm</u> in <u>Boston</u>. <br />
                                                               Nice to meet you.</p></div>
                    </div>
                    
                    <div class="small-6 columns yk_right_person_dialogue">               		  
                   	  <div class="dial"><p class="dial_right_1">I’m a <u>doctor</u>.<br />
                                                                I work at a <u>hospital</u> in <u>Chicago</u>.<br />
                                                                 How about you?</p></div>
            ...
            <a class="button" href="jobs_convo_dialogue.php">Previous </a>
            <a class="button" id="reset">Again </a>
            <a class="button" href="jobs_convo_dialogue_page3.php">Next</a>
        ...
        <div>
            		<audio id="yk_audio_dialogue_1">
                           <source src="../Audio/jobs/Dialogue/simple5.mp3" type="audio/mpeg">
                            Your browser does not support the audio element.
                    </audio>
                    
                    <audio id="yk_audio_dialogue_2">
                           <source src="../Audio/jobs/Dialogue/simple6.mp3" type="audio/mpeg">
                            Your browser does not support the audio element.
                    </audio>
                    
                    <audio id="yk_audio_dialogue_3">
                           <source src="../Audio/jobs/Dialogue/simple7a.mp3" type="audio/mpeg">
                            Your browser does not support the audio element.
                    </audio>
                    
                     <audio id="yk_audio_dialogue_4">
                           <source src="../Audio/jobs/Dialogue/simple8a.mp3" type="audio/mpeg">
                            Your browser does not support the audio element.
                    </audio>
        </div>
