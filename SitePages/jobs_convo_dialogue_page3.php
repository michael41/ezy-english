...
<div class="row ykmainbodywrapper">
	    ...
	    <div class="small-6 columns ykmainbody">
            ...
            <div class="row yk_dialogue_images">
                    ...
                    <div class="small-6 columns">
                                ...
                                <div class="row">
                                        ...
                                        <div class="small-4 columns">
                                             <img class="hint_pic hint_pic_1" src="../Images/Dialogue/tip_accountancyfirm.png" />   
                                        </div>
                                            
                                        <div class="small-8 columns">
                                              <img class="pic_left_1" src="../Images/Dialogue/Accountant.png" />  
                                        </div>
                    ...
                    <div class="medium-6 columns">
                                ...
                                <div class="row">
                                        ...
                                        <div class="small-8 columns">
                                              <img class="pic_right_1" src="../Images/Dialogue/Nurse.png" />   
                                        </div>
                                        
                                        <div class="small-4 columns">
                                               <img class="hint_pic hint_pic_2" src="../Images/Dialogue/tip_hospital.png" /> 
                                        </div>
            ...
            <div class="row yk_left_and_right_person_dialogue_row">                        		
                    ...
                    <div class="small-6 columns yk_left_person_dialogue">
                      ...
                      <div class="dial"><p class="dial_left_2">I'm an <u>accountant</u>.<br />
                                                               I work <u>for an accountancy firm</u> in <u>Cape Town</u>.<br />
                                                               Nice to meet you.</p></div>
                    </div>
                    
                    <div class="small-6 columns yk_right_person_dialogue">               		  
                   	  <div class="dial"><p class="dial_right_1">I’m a <u>nurse</u>.<br />
                                                                I work <u>in a hospital</u> in <u>Dublin</u>.<br />
                                                                How about you?</p></div>
            ...
            <a class="button" href="jobs_convo_dialogue_page2.php">Previous </a>
            <a class="button" id="reset">Again </a>
            <a class="button" href="jobs_convo_dialogue_page4.php">Next</a>
        ...
        <div>
            		<audio id="yk_audio_dialogue_1">
                           <source src="../Audio/jobs/Dialogue/simple9.mp3" type="audio/mpeg">
                            Your browser does not support the audio element.
                    </audio>
                    
                    <audio id="yk_audio_dialogue_2">
                           <source src="../Audio/jobs/Dialogue/simple10.mp3" type="audio/mpeg">
                            Your browser does not support the audio element.
                    </audio>
                    
                    <audio id="yk_audio_dialogue_3">
                           <source src="../Audio/jobs/Dialogue/simple11a.mp3" type="audio/mpeg">
                            Your browser does not support the audio element.
                    </audio>
                    
                     <audio id="yk_audio_dialogue_4">
                           <source src="../Audio/jobs/Dialogue/simple12a.mp3" type="audio/mpeg">
                            Your browser does not support the audio element.
                    </audio>
        </div>
