...
$img_dir = "../Images/Images8InEach/Phrases/" . $topic_name . "/";
$images = scandir($img_dir);


// Open the audio directory, and read its contents
$audio_dir = "../Audio/" . $topic_name . "/Phrases/";
...
$(document).ready(function() {
	...
	var audiosrc1 = "../Audio/" + topic_for_this_page + "/Phrases/" + audio1;
	var audiosrc2 = "../Audio/" + topic_for_this_page + "/Phrases/" + audio2;
	var audiosrc3 = "../Audio/" + topic_for_this_page + "/Phrases/" + audio3;
	var audiosrc4 = "../Audio/" + topic_for_this_page + "/Phrases/" + audio4;
	var audiosrc5 = "../Audio/" + topic_for_this_page + "/Phrases/" + audio5;
	var audiosrc6 = "../Audio/" + topic_for_this_page + "/Phrases/" + audio6;
	var audiosrc7 = "../Audio/" + topic_for_this_page + "/Phrases/" + audio7;
	var audiosrc8 = "../Audio/" + topic_for_this_page + "/Phrases/" + audio8;
